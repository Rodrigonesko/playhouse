    ...
    <div class="container-cardapio">
        <div class="item-cardapio">
            ...
            <div>
                ...
                <div>
                    ...
                    <input type="text" name="outra-mesa-boas-vindas" id="outra-mesa-boas-vindas" placeholder="Outra Mesa de Boas Vindas" class="input <?php if (!$checkboxOutraMesa) {
                                                                                                                                                            echo 'none';
                                                                                                                                                        } ?>" value="<?php echo $outraMesaBoasVindas ?>">
                </div>
            </div>
        </div>
        <div class="item-cardapio">
            ...
            <div>
                ...
                <div class="control">
                    <label class="radio">
                        <input type="radio" name="outra_opcao_entrada" class="outra-entrada" value="Sim" <?php if ($checkboxOutraEntrada) {
                                                                                                                echo 'checked';
                                                                                                            } ?>>
                        Sim
                    </label>
                    <label class="radio">
                        <input type="radio" name="outra_opcao_entrada" class="outra-entrada" value="Não" <?php if (!$checkboxOutraEntrada) {
                                                                                                                echo 'checked';
                                                                                                            } ?>>
                        Não
                    </label>
                </div>
                <input type="text" name="outra-entrada" id="outra-entrada" placeholder="Outra Opção de Entrada" class="input <?php if (!$checkboxOutraEntrada) {
                                                                                                                                    echo 'none';
                                                                                                                                } ?>" value="<?php echo $outraEntrada ?>">
            </div>
        </div>
        <div class="item-cardapio">
            <h3>Bebida Extra</h3>
            ...
            <div>
                ...
                <input type="text" name="outra-bebida-extra" id="outra-bebida-extra" placeholder="Outra Bebidas Extras" class="input <?php if (!$checkboxOutraBebiba) {
                                                                                                                                            echo 'none';
                                                                                                                                        } ?>" value="<?php echo $outraBebidaExtra ?>">
            </div>
        </div>
            ...
            <div class="container-salgados">
                <div>
                    <div class="is-justify-content-center is-flex is-align-items-center">
                        ...
                        <input type="number" name="quantidade-salgados-1" id="quantidade-salgados-1" value="<?php echo $quantidadeSalgados1 ?>" class="input">
                    </div>
                    <div class="is-justify-content-center is-flex is-align-items-center">
                        <div class="select">
                        ...
                        <input type="number" name="quantidade-salgados-2" id="quantidade-salgados-2" value="<?php echo $quantidadeSalgados2 ?>" class="input">
                    </div>
                    <div class="is-justify-content-center is-flex is-align-items-center">
                        <div class="select">
                        ...
                        <input type="number" name="quantidade-salgados-3" id="quantidade-salgados-3" value="<?php echo $quantidadeSalgados3 ?>" class="input">
                    </div>
                    <div class="is-justify-content-center is-flex is-align-items-center">
                        <div class="select">
                        ...
                        <input type="number" name="quantidade-salgados-7" id="quantidade-salgados-7" value="<?php echo $quantidadeSalgados7 ?>" class="input">
                    </div>
                ...
                <div>
                    <div class="is-justify-content-center is-flex is-align-items-center">
                        ...
                        <input type="number" name="quantidade-salgados-4" id="quantidade-salgados-4" value="<?php echo $quantidadeSalgados4 ?>" class="input">
                    </div>
                    <div class="is-justify-content-center is-flex is-align-items-center">
                        <div class="select">
                        ...
                        <input type="number" name="quantidade-salgados-5" id="quantidade-salgados-5" value="<?php echo $quantidadeSalgados5 ?>" class="input">
                    </div>
                    <div class="is-justify-content-center is-flex is-align-items-center">
                        <div class="select">
                        ...
                        <input type="number" name="quantidade-salgados-6" id="quantidade-salgados-6" value="<?php echo $quantidadeSalgados6 ?>" class="input">
                    </div>
                    <div class="is-justify-content-center is-flex is-align-items-center">
                        <div class="select">
                        ...
                        <input type="number" name="quantidade-salgados-8" id="quantidade-salgados-8" value="<?php echo $quantidadeSalgados8 ?>" class="input">
                    </div>
                </div>
                <div>
                    ...
                    <input type="text" name="outro-salgado" id="outra-opcao-salgado" placeholder="Outra Opção Salgado" class="input <?php if (!$checkBoxOutroSalgado) {
                                                                                                                                        echo 'none';
                                                                                                                                    } ?>" value="<?php echo $outroSalgado ?>">
                </div>
            </div>
        </div>
        ...
        <div class="item-cardapio">
            ...
            <div class="brownie">
                ...
                <div class="control">
                    <label class="radio">
                        <input type="radio" name="brownie" value="Sim" <?php if ($brownie == 'Sim') {
                                                                            echo 'checked';
                                                                        } ?>>
                        Sim
                    </label>
                    <label class="radio">
                        <input type="radio" name="brownie" value="Não" <?php if ($brownie == 'Não') {
                                                                            echo 'checked';
                                                                        } ?>>
                        Não
                </div>
            ...
            <div class="doces">
                <div>
                    ...
                    <div class="is-justify-content-center is-flex is-align-items-center">
                        ...
                        <input type="number" name="quantidade-simples-1" id="quantidade-simples-1" value="<?php echo $quantidadeSimples1 ?>" class="input">
                    </div>
                    <div class="is-justify-content-center is-flex is-align-items-center">
                        <div class="select">
                        ...
                        <input type="number" name="quantidade-simples-2" id="quantidade-simples-2" value="<?php echo $quantidadeSimples2 ?>" class="input">
                    </div>
                    <div class="is-justify-content-center is-flex is-align-items-center">
                        <div class="select">
                        ...
                        <input type="number" name="quantidade-simples-3" id="quantidade-simples-3" value="<?php echo $quantidadeSimples3 ?>" class="input">
                    </div>
                    <div class="is-justify-content-center is-flex is-align-items-center">
                        <div class="select">
                        ...
                        <input type="number" name="quantidade-simples-4" id="quantidade-simples-4" value="<?php echo $quantidadeSimples4 ?>" class="input">
                    </div>
                </div>
                <div>
                    <h5>Especiais</h5>
                    <div class="is-justify-content-center is-flex is-align-items-center">
                        ...
                        <input type="number" name="quantidade-especiais-1" id="quantidade-especiais-1" value="<?php echo $quantidadeEspecial1 ?>" class="input">
                    </div>
                    <div class="is-justify-content-center is-flex is-align-items-center">
                        <div class="select">
                        ...
                        <input type="number" name="quantidade-especiais-2" id="quantidade-especiais-2" value="<?php echo $quantidadeEspecial2 ?>" class="input">
                    </div>
                    <div class="is-justify-content-center is-flex is-align-items-center">
                        <div class="select">
                        ...
                        <input type="number" name="quantidade-especiais-3" id="quantidade-especiais-3" value="<?php echo $quantidadeEspecial3 ?>" class="input">
                    </div>
                    <div class="is-justify-content-center is-flex is-align-items-center">
                        <div class="select">
                        ...
                        <input type="number" name="quantidade-especiais-4" id="quantidade-especiais-4" value="<?php echo $quantidadeEspecial4 ?>" class="input">
                    </div>
                </div>
            </div>
            <div>
                ...
                <input type="text" name="outro-doce" id="outra-opcao-doce" placeholder="Outra Opção Doce" class="input <?php if (!$checkboxOutroDoce) {
                                                                                                                            echo 'none';
                                                                                                                        } ?>" value="<?php echo $outroDoce ?>">
            </div>
        </div>
