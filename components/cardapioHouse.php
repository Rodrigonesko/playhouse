...
<div class="item-cardapio">
    ...
    <div>
        ...
        <div class="control">
            <label class="radio">
                <input type="radio" name="outra_opcao_entrada" class="outra-entrada" value="Sim">
                Sim
            </label>
            <label class="radio">
                <input type="radio" name="outra_opcao_entrada" class="outra-entrada" value="Não">
                Não
            </label>
        </div>
        <input type="text" name="outra-entrada" id="outra-entrada" placeholder="Outra Opção de Entrada" class="input none">
    </div>
</div>
    ...
    <div class="container-salgados">
        <div>
            ...
            <div>
                ...
                <input type="number" name="quantidade-salgados-8" id="quantidade-salgados-8" class="input">
            </div>
        </div>
        <div>
            <div>
            ...
            <div>
                ...
                <input type="number" name="quantidade-salgados-7" id="quantidade-salgados-7" class="input">
            </div>
        </div>
        <div>
    ...
    <div class="doces">
        <div>
            ...
            <div>
                ...
                <input type="number" name="quantidade-simples-4" id="quantidade-simples-4" class="input">
            </div>
        </div>
        <div>
            <h5>Especiais</h5>
            ...
            <div>
                ...
                <input type="number" name="quantidade-especiais-3" id="quantidade-especiais-3" class="input">
            </div>
            <div>
                <div class="select">
                ...
                <input type="number" name="quantidade-especiais-4" id="quantidade-especiais-4" class="input">
            </div>
        </div>
    </div>
    <div>
