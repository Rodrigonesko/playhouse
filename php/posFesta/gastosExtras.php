...
if (isset($_POST['adicionar'])) {
    $id = $_GET['id_festa'];
    $item = $_POST['gasto_extra_item'];
    $quantidade = $_POST['gasto_extra_quantidade'];
    $valor = $_POST['gasto_extra_valor'];
    $categoria = 'Gasto extra';

    $insert = $mysqli->prepare("INSERT INTO gastos_extras (id_festa, item, quantidade, valor, categoria) VALUES (?,?,?,?,?)");
    $insert->bind_param('issss', $id, $item, $quantidade, $valor, $categoria);
    $insert->execute();
