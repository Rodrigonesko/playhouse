            ...
            <div class="details-container">
                ...
                <div class="container-inputs">
                    <div class="input-box">
                        ...
                        <label for="n-people">N° Pessoas: </label>
                        <input type="number" id="n-people" name="n-people">
                    </div>
                    <div class="input-box">
                        <label for="excedents">Convidados exdentes: </label>
                        <input type="text" id="excedents" name="excedents">
                    </div>
                    <div class="input-box">
                        <label for="value">Valor: </label>
                ...
                <div class="details-container">
                    ...
                    <div class="input-box">
                        <label for="date-party">Data da festa: </label>
                        <input type="date" name="date-party" id="date-party">
                        <label for="time">Horário</label>
                ...
                <div class="details-container">
                    ...
                    <div class="input-box">
                        <label for="mid_contact">Por meio do contato: </label>
                        <input type="text" name="mid_contact" id="mid_contact">
                        <span>do Buffet Play House</span>
                    </div>
                    <div class="input-box">
                        <label for="color_balloons">Cor das bexigas: </label>
                        <input type="text" name="color_balloons" id="color_balloons">
                    </div>
                    <div class="input-box">
                        <label for="furniture">Mobiliario: </label>
                        <input type="text" name="furniture" id="furniture">
                    </div>
                    <div class="input-box">
                        <label for="optional">Opcional: </label>
